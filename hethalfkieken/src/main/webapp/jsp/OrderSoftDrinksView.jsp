...
--%>
<%
  String pageTitle = "Frisdranken bestellen";
...
<div class="container-fluid">
  ...
  <div class="row my-3">
    <nav class="nav nav-pills flex-column flex-sm-row">
      <a class="flex-sm-fill text-sm-center nav-link"  href="OrderFriesView.jsp">Frieten</a>
      ...
      <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="OrderSoftDrinksView.jsp">Frisdranken</a>

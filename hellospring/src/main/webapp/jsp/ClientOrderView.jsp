    ...
    <div class="col-sm-12 col-md-10 col-lg-8 border border-danger border-4 text-center p-5">
      <div class="row">
        <div class="col-sm-12 col-lg-8">
          <h1 class="fw-bold">Bedankt voor je bestelling, <%=request.getAttribute("name")%></h1>
        ...
        <div class="col-sm-12 col-lg-4">
          <img src="/images/thanks.jpg" alt="bedankt" class="img-fluid" style="opacity: 0.59;  box-sizing: border-box;" />
